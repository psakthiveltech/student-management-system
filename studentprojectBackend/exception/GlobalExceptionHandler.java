...
public class GlobalExceptionHandler {
    ...
    // this is for studentnotfoundexception
    ...
    public ResponseEntity<Map<String,String>> handleFieldExceptions(MethodArgumentNotValidException ex){
    ...
    public ResponseEntity<Map<String,String>> handleALlUnExpectedException(Exception er){
